...
<a class="flex items-center gap-xs uppercase tracking-wide mt-xxs" href="/store/info">
...
<p class="mt-1.5xl leading-relaxed">
	If you are a stylist of photographer and would like to feature one of our pieces in a photoshoot,
	please don't hesitate to send an email to <a href={`mailto:${contact.email}`}>{contact.email}</a>.
</p>

<h4 class="mt-xl">Information to know:</h4>
<p class="mt-xs leading-relaxed">
	- Following the explanation of your project, we will send you a list of available pieces, as well
	as their retail price.<br />
	...
	each piece is hand-dyed and unique, we only have a small stock, the risk of damage or the length of
	the rental period would result in a loss for our business and cannot be exchanged for visibility.<br
	/>
